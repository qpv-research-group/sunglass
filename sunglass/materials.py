...
class MaterialsTab(ttk.Frame):
    ...
    def populate_materials_list(self):
        ...
        mat_list_scroll = ttk.Scrollbar(
            self, orient=tk.VERTICAL, command=self.mat_list.yview
        )
        ...
        mat_properties_scroll = ttk.Scrollbar(
            self, orient=tk.VERTICAL, command=self.mat_properties.yview
        )
