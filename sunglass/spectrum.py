...
from solcore import eVnm, mJ, nmHz, nmJ
from solcore.constants import c, h, q
from solcore.light_source.light_source import REGISTERED_CONVERTERS, LightSource
...
class SpectrumTab(ttk.Frame):
    ...
    def __init__(self, parent: ttk.Notebook) -> None:
        ...
        self.spectrum = StandardSpectrum(
            parent=self.control_frame, row=4, update=self.update_plot
        )
        self.update_plot()
    ...
    def create_control_area(self):
        ...
        spectrum_type_box = ttk.Combobox(
            general_properties_frame,
            state="readonly",
            values=LightSource.type_of_source,
        ...
        units_box = ttk.Combobox(
            general_properties_frame,
            state="readonly",
            values=list(REGISTERED_CONVERTERS.keys()),
        ...
        range_label = ttk.Label(
            general_properties_frame, text="Range (min, max, points) in: "
        )
        ...
        x_points_label = ttk.Entry(
            general_properties_frame, textvar=self.x_points, width=10
        )
...
class StandardSpectrum(ttk.LabelFrame):
    ...
    def __init__(
        ...
        source_version_box = ttk.Combobox(
            self,
            state="readonly",
            values=["AM0", "AM1.5g", "AM1.5d"],
